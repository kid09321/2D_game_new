...
public class Sound
{
    ...
    public Vector2 m_randomVolumeRange = new Vector2(0.0f, 0.5f);
    public Vector2 m_randomPitchRange = new Vector2(0.0f, 0.5f);
    ...
    public void Play()
    {
        ...
        Debug.Log("currentSource playing: " + m_source.name);
        m_source.Play();
    }
}
